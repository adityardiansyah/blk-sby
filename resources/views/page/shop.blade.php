...
@section('content')
    ...
    <div class="modal fade text-left" id="modal_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
        aria-hidden="true">
                ...
                <form action="{{ route('seller.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="nama toko" class="form-control" name="name" required
                                value="{{ old('name') }}">
                        </div>
                        <label>Lokasi</label>
                        <div class="form-group">
                            <input type="text" placeholder="Lokasi" class="form-control" name="location" required
                                value="{{ old('location') }}">
                        </div>
                        <label>Alamat</label>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="latitude" class="form-control" name="latitude" required
                                value="{{ old('latitude') }}">
                        </div>
                        <label>Longitude</label>
                        <div class="form-group">
                            <input type="text" placeholder="longitude" class="form-control" name="longitude" required
                                value="{{ old('longitude') }}">
                        </div>
    ...
    <div class="modal fade text-left" id="modal_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                @endif
                <form action="{{ route('master.shop.update') }}" method="POST" class="edit-form"
                    ...
                    <div class="modal-body">
                        <label>Nama Toko</label>
                        <div class="form-group">
                            <input type="text" placeholder="nama toko" class="form-control" name="name"
                                id="shop_name" required value="{{ old('name') }}">
                        </div>
                        <label>Lokasi</label>
                        <div class="form-group">
                            <input type="text" placeholder="Lokasi" class="form-control" name="location"
                                id="shop_location" required value="{{ old('location') }}">
                        </div>
                        <label>Alamat</label>
                        <div class="form-group">
                            <input type="text" placeholder="Alamat" class="form-control" name="address"
                                id="shop_address" required value="{{ old('address') }}">
                        </div>
                        <label>Latitude</label>
                        <div class="form-group">
                            <input type="text" placeholder="latitude" class="form-control" name="latitude"
                                id="shop_latitude" required value="{{ old('latitude') }}">
                        </div>
                        <label>Longitude</label>
                        <div class="form-group">
                            <input type="text" placeholder="longitude" class="form-control" name="longitude"
                                id="shop_longitute" required value="{{ old('longitude') }}">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
