                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm"
                                            onclick="lihat({{ $item->id }})">Detail</button>
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div class="modal fade text-left modal-xl" id="modal_show" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                @endif
                @if (count($data) > 0)
                    <form action="{{ route('returnwarehouse.show', ['id' => $item->id]) }}" method="POST"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input readonly type="text" placeholder="No. Transaksi" class="form-control"
                                            name="notrans" id="trans_no" required value="{{ old('trans_no') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input readonly type="date" placeholder="Tgl. Transaksi" class="form-control"
                                            name="tgltrans" id="trans_date" required value="{{ old('trans_date') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input readonly type="text" placeholder="Nama Seller" class="form-control"
                                            name="name" id="seller" required value="{{ old('name') }}">
                                    </div>
                                </div>
