            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="Tipe" class="form-control" name="name" required value="OUT" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="conversion" id="conversion" class="form-control select2" required >
    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            $.each(data, function(key, value) {
                $("#conversion").append('<option value="' + key + '">' + value + '</option>');
            });
        },
        complete:function() {
            //
