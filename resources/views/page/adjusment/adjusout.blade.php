            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="Tipe" class="form-control" name="type" required value="OUT" readonly>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <label>Type</label>
                    <div class="form-group">
                        <input type="text" placeholder="Tipe" class="form-control" name="type-edit" required value="OUT" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Toko</label>
                    ...
                    <label>Notes</label>
                    <div class="form-group">
                        <input type="text" placeholder="Catatan" class="form-control" name="notes-edit" id="notes-edit" required value="{{ old('notes') }}">
                    </div>
                    <label>Status</label>
                    <div class="form-group">
