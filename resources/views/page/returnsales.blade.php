...
@section('content')
    ...
    <div class="page-content">
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('returnsales.index') }}"><button
    ...
    <div class="modal fade text-left" id="modal_filter" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" readonly placeholder="tanggal transaksi"
                                            class="form-control" name="trans_date" id="trans_date" required
